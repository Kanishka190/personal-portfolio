    ...
    return (
        <div id="contact">
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-12'>
                ...
                className='text-4xl font-bold text-white'>Let's Discuss our <span className='text-purple-500'>Projects</span></motion.h2>
                <motion.p 
                ref={ref}
                initial={{ opacity: 0, y: -100 }}
                animate={inView ? { opacity: 1, y: 0 } : {}}
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 grid grid-cols-1 md:grid-cols-2 gap-8'>
                <div className='space-y-6'>
                    ...
                    className='flex items-center space-x-4'>
                        ...
                        <div>
                            ...
                            <p className='text-white'> Madurai, TamilNadu</p>
                        </div>
                    </motion.div>
                </div>
                ...
                className='space-y-4 text-white'>
                    ...
                    <div  className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                        ...
                        <input type="email" placeholder='Package' className='border border-purple-500 bg-gray-900 p-4 rounded-md w-full'/>
                    </div>
