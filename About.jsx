...
import aboutImg from "../assets/brain_1-removebg.png"
        ...
        <div id="about" className='text-white py-16'>
            <div className='container mx-auto px-4 text-center'>
                ...
                <motion.p
                    ...
                    className='mb-12 text-gray-300 text-center'>Lorem, ipsum dolor sit amet consectetur adipisicing elit.Quod,incidunt id.
                </motion.p>
                <div className='flex flex-col md:flex-row justify-center items-center'>
                    ...
                    <motion.p
                        ...
                        I'm currently doing my internship on MERN stack development!!!.
                    </motion.p>
                </div>
                <div className='flex flex-col sm:flex-row justify-around items-center mt-12space-y-6 sm:space-y-0'>
                    ...
                    >
                        <h3 className='text-3xl md:text-8xl font-bold md:my-6 text-purple-500'>6+</h3>
                        <motion.p
                         ref={ref}
                         initial={{ opacity: 0, y: 100 }}
                         animate={inView ? { opacity: 1, y: 0 } : {}}
